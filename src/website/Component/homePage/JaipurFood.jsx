...
const JaipurFood = () => {
  ...
  // ];
// cache
// const BASE_URL = env.process.REACT_APP_BASE_URL;
  ...
  return (
    <div>
      ...
      <div className="flex justify-between flex-wrap">
        {products.map(
            (product, indx)=>{  
                return  <FoodBox key={indx} boxSize={280} img="./img/product2.avif" title={product.title} rating={product.discount} timing={product.timeframe} subText={product.subText} />
            }
        )}
        {/* img={product.pathname+product.image} */}
      </div>
    </div>
  );
};
